...
mkdir -p "$CONTENTS/Resources/Assets/Cursor"
...
rsync -a --delete "$NATIVE_DIR/Assets/Cursor/" "$CONTENTS/Resources/Assets/Cursor/"
...
echo "  - assets:    $CONTENTS/Resources/Assets/{Icons,Sprites,Font,Border,Cursor}"
